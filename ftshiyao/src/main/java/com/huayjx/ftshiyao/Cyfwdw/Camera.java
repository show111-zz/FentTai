...
public class Camera extends BaseActivity {
    ...
    private CyCameraAdapter adapter;

    @InjectView(R.id.yp_caremaView) GridView cameraView;//照片框
    ...
    public void showDialogmeg(){
        ...
        builder.setMultiChoiceItems(tiplog, null, new DialogInterface.OnMultiChoiceClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                if (isChecked) {
//                    Toast.makeText(Camera.this, "您选择的环境是:" + tiplog[which], Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        super.onActivityResult(requestCode, resultCode, data);
           if (requestCode == 1) {
               ...
               if (!sdStatus.equals(Environment.MEDIA_MOUNTED)) { // 检测sd是否可用
                   Toast.makeText(Camera.this, "请安装SD卡", Toast.LENGTH_SHORT).show();
                   return;
               }
               ...
               adapter = new CyCameraAdapter(Camera.this,R.layout.camer_grid_layout,listBitmap);
